...
<body>
<div class="d-flex justify-content-center align-center"style="background-image:url(images/batch.jpeg.jpg); 
         ...
         <form action="shiftbatch">
             <input type="text" name="studentid" value="${st.studentId}" hidden="true">
              <div class="bg-dark p-2 d-flex justify-content-between">
                  <label for="batch" class="text-info"><b>Select Batch Number</b></label>
                   <div class="col">
